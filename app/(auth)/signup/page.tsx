...
export default function SignupPage() {
  ...
  async function handleGithub() {
    await signIn("github", { callbackUrl: "/lessons" });
  }

  return (
    <div className="min-h-screen bg-gray-50 flex flex-col items-center px-6 pt-16 pb-10">
      <div className="w-full max-w-[400px]">
        {/* Wordmark */}
        <div className="text-center mb-8">
          <Link
            href="/"
            className="inline-block font-bold text-gray-900 text-2xl tracking-tight"
          >
            CodeLearn
          </Link>
        </div>
        ...
        <div className="text-center mb-6">
          ...
          <p className="text-sm text-gray-500 mt-1.5">Free forever — no credit card needed</p>
        </div>
