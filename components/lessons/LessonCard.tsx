    ...
    <div
      className={cn(
        ...
        locked
          ...
          : completed
          ? "bg-white border-gray-100 shadow-sm hover:shadow-md cursor-pointer group"
          : "bg-white border-gray-100 shadow-sm hover:shadow-md hover:border-blue-100 cursor-pointer group"
      )}
    >
      {/* Status circle */}
      <div
      ...
      <div className="flex-1 min-w-0">
        <div className="flex items-center gap-2">
          ...
          {lesson.tier === "pro" && (
            <span className="inline-flex items-center gap-1 bg-purple-100 text-purple-700 text-[10px] font-bold uppercase tracking-wide px-1.5 py-0.5 rounded shrink-0">
